...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wngksfu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wngksfu.containers.anotherwebservice.com/
...
```
git clone git@github.com:newone1103/container-wngksfu.git
cd container-wngksfu
```
...
```
docker attach container-wngksfu
```
